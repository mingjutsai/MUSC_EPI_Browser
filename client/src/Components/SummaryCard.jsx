...
export default function SummaryCard(props) {
    ...
    if (props.wf === "disease") {
        ...
        summary = {
            ...
            "HGNC":"https://www.genenames.org/data/gene-symbol-report/#!/hgnc_id/HGNC:" + props.gene_summary_info.hgnc,
            "ENSEMBL":"http://uswest.ensembl.org/Homo_sapiens/Gene/Summary?g=" +props.gene_summary_info.ensembl,
          ...
          Word of the Day
                        ...
                        <br />
                        {
                            Object.keys(summary).map((key, index) => {
                                if (key !== "GWAS catalog" && key !== "OMIM" && key !== "dnSNP" && key !== "HGNC" && key !== "ENSEMBL") {
                                    return (
                                        <div>
                                            ...
                                            <Typography variant="h6" component="p" style={{textIndent:"10px"}}>
                                            {summary[key]}
                                            </Typography>
                                            <br />
                                        </div>
                ...
                <p style={{textAlign:"center"}}>There are {n_snp} unique SNPs identified for this trait based on GWAS catalog.</p>
            </Grid>: props.wf == "disease"?
                <Grid item xs={4}>
                    <CardContent>
                        <DistChart
                            cnt={props.cnt}
